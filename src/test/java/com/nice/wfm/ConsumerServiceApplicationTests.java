...
@AutoConfigureStubRunner(ids = "com.nice.wfm:provider-service:+:stubs:8080", workOffline = true)
public class ConsumerServiceApplicationTests {
    ...
    @Test
    public void applicationShouldBeDeniedWhenCreditScoreIsLow() throws Exception {
        mockMvc.perform(
                post("/credit-card-applications")
                        .contentType(APPLICATION_JSON)
                        .content("{" +
